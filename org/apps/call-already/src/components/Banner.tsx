...
export const Banner: React.FC<BannerProps> = ({message, onClose}) => {
  ...
  return (
    <div style={{border: "1px solid red", padding: "1em", borderRadius: "3px", margin: "0 auto 0 auto", boxShadow: "3px 3px red"}}>
      <div style={{display: "flex", gap: "0.5em", alignItems: "center"}}>
        <CloseButton style={{color: "red"}} mr={-6} onClick={() => onClose()} />
